...
function Aboutpage () {
  ...
  <div>
    <div id="container" className="dark-wrap">
      ...
      <p>The <Link to="/resume/">resume page</Link> pulls from a few JSON files using GraphQL.</p>
      <p><a href="https://github.com/sarahg/sarahg.github.io">Browse source on GitHub</></p>
